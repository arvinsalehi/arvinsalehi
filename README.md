...
# Path and Resources 
I started with back-end then server administration then machine vision on embedded devices and platfrom engineering. And here you can find some of my introductory resources which helped me find my current passion (Apart of source codes and official documents and random source codes based on interests). I'm more aligned towards learning the desinging, releasing and optimizing software. Maybe a tiny bit Assembly.
